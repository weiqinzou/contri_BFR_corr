...
Rscript --slave merge_contri.R rptInfo_E_BFR E_rpt E_fix E_cmt E
Rscript --slave merge_contri.R rptInfo_M_BFR M_rpt M_fix M_cmt M
...
Rscript --slave sameStart.R E_BFR_rfc 10 >sameStart_E.res
Rscript --slave sameStart.R M_BFR_rfc 10 >sameStart_M.res

Rscript --slave relative_when.R E_BFR_rfc 10 > relativeWhen_E.res
Rscript --slave relative_when.R M_BFR_rfc 10 > relativeWhen_M.res
